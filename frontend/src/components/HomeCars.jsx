...
//GET NUMBER OF DAYS HERE AS FROM WHEN TILL IT IS BOOKED ALSO.
...
const HomeCars = () => {
  ...
  }; //GET IMAGE IF NOT PRESENT THEN A PLACEHOLDER THERE
    ...
    if (Array.isArray(car.bookings) && car.bookings.length) {
      const overlapping = car.bookings
        ...
        .filter((b) => {
          ...
          // Ignore any pending or unpaid bookings so the car remains available until the payment is confirmed.
          if (status === "pending" || paymentStatus === "pending") return false;

          // Treat confirmed bookings as blocking (paid or marked active/upcoming).
          return (
            paymentStatus === "paid" ||
            status === "active" ||
            status === "upcoming"
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Same width as grid; directly under heading, above cards */}
              ...
              >
                ...
                <div className={styles.priceBadge}>
                  <span className={styles.priceText}>
                    Rs{car.dailyRate ?? car.price ?? 0}/day
                  </span>
                </div>
