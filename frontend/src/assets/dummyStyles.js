...
export const heroStyles = {
  ...
  topBand: "absolute inset-x-0 top-0 h-20 sm:h-24 lg:h-28 bg-black z-[6] pointer-events-none",
  gradientOverlay: "absolute inset-0 bg-gradient-to-b from-black from-0% via-black/85 via-[22%] to-transparent to-[48%] pointer-events-none z-[5]",
  ...
  ctaCard: "relative rounded-2xl p-6 bg-white border border-gray-200 shadow-xl flex items-center justify-between gap-4",
  subtitle: "text-xs uppercase tracking-widest text-sky-300/70",
  title: "text-gray-900 md:text-sm text-lg sm:text-2xl font-semibold mt-1",
  description: "mt-1 text-sm text-gray-600/70",
  ...
  buttonText: "text-sm",
  outline: "absolute -inset-1 rounded-2xl pointer-events-none ring-1 ring-gray-200"
};

// assets/dummyStyles.js
export const loginStyles = {
  pageContainer: "min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-500 px-4 sm:px-6 md:px-8 text-gray-900",
  ...
  backButton: "absolute top-3 left-6 z-10 flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-3 rounded-full transition-shadow duration-300 shadow-lg hover:shadow-xl bg-white text-gray-900 hover:bg-gray-100",
  
  loginCard: {
    container: "w-full max-w-md sm:mt-14 z-10 transform transition-all duration-500 hover:scale-[1.02]",
    card: "glass-card relative overflow-hidden p-6 sm:p-8 rounded-3xl transition-colors duration-500",
    ...
    logoText: "flex flex-col items-center text-xl md:text-2xl lg:text-2xl leading-none font-bold tracking-wider text-gray-900",
    title: "text-2xl sm:text-3xl font-bold tracking-tight bg-gradient-to-r from-orange-500 to-gray-900 bg-clip-text text-transparent",
    subtitle: "mt-1 sm:mt-2 font-light tracking-wider text-xs sm:text-sm text-orange-600/80"
  },
  ...
  form: {
    ...
    inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-orange-500",
    input: "glass-input w-full pl-10 pr-3 py-3 sm:py-4 rounded-xl text-sm sm:text-base placeholder-opacity-70 border transition duration-300 focus:outline-none focus:ring-2 focus:border-transparent backdrop-blur-sm placeholder-gray-400 focus:ring-orange-500/70",
    passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer transition-colors text-orange-500 hover:text-orange-600",
  ...
  signupSection: "mt-6 pt-6 border-t border-gray-200 text-center text-xs sm:text-sm",
  signupText: "text-gray-600",
  signupButton: "inline-block mt-2 w-full cursor-pointer px-4 py-2 rounded-xl font-medium transition-transform duration-300 transform hover:-translate-y-0.5 bg-transparent border border-orange-500 text-orange-600 hover:bg-orange-50 hover:text-orange-700"
};


// assets/dummyStyles.js
export const signupStyles = {
  pageContainer: "min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-500 text-gray-900 px-4 sm:px-6",
  ...
  backButton: "absolute top-4 sm:top-6 left-4 sm:left-6 z-10 flex items-center gap-1 sm:gap-2 px-3 py-2 sm:px-4 sm:py-3 rounded-full transition-all duration-300 group shadow-lg hover:shadow-xl bg-white text-gray-900 hover:bg-gray-100",
  ...
  signupCard: {
    ...
    card: "glass-card rounded-3xl overflow-hidden p-4 sm:p-6 md:p-8 relative transition-all duration-500",
    ...
    title: "text-2xl sm:text-3xl md:text-4xl font-bold mt-2 sm:mt-3 md:mt-4 tracking-tight bg-gradient-to-r from-orange-500 to-gray-900 bg-clip-text text-transparent",
    subtitle: "mt-1 sm:mt-2 text-xs sm:text-sm md:text-base font-light tracking-wider text-orange-600/80"
  },
  ...
  form: {
    ...
    inputWrapper: "relative",
    inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-orange-500",
    input: "glass-input w-full pl-10 pr-3 py-2 sm:py-3 md:py-4 rounded-xl text-xs sm:text-sm placeholder-opacity-70 border focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 backdrop-blur-sm placeholder-gray-400 focus:ring-orange-500/70",
    passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer transition-colors text-orange-500 hover:text-orange-600",
    checkbox: "h-4 w-4 sm:h-5 sm:w-5 rounded focus:ring-0 border text-orange-600 border-gray-500 bg-gray-200/30 checked:bg-orange-500/80",
    checkboxLabel: "ml-2 sm:ml-3 text-xs sm:text-sm text-gray-600 cursor-pointer select-none",
  ...
  signinText: "mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base text-gray-600",
  signinButton: "inline-block w-full px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-xl font-medium transition-all duration-300 transform hover:-translate-y-0.5 text-xs sm:text-sm md:text-base bg-transparent border border-orange-500 text-orange-600 hover:bg-orange-50 hover:text-orange-700"
};
...
export const homeCarsStyles = {
  container: "relative w-full overflow-hidden py-16 bg-white text-gray-800 min-h-screen",
  headerContainer: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16",
  premiumBadge: "inline-flex items-center px-4 py-2 rounded-full bg-gray-50 border border-gray-200 backdrop-blur-sm border border-gray-200 mb-4",
  ...
  priceBadge: "absolute top-40 md:top-50 lg:top-50 right-4 z-20 bg-white/95 backdrop-blur-md text-gray-900 px-3 py-1.5 rounded-full font-bold text-sm shadow-lg flex items-center",
  ...
  carName: "text-xl font-bold text-gray-900",
  carInfoContainer: "text-gray-400 flex items-center mt-1",
  carTypeBadge: "bg-gray-100 text-orange-400 px-2.5 py-1 rounded-full mr-2 text-xs font-medium",
  carYear: "text-gray-500 text-sm",
  specsGrid: "grid grid-cols-4 gap-3 my-5",
  specItem: "flex flex-col items-center",
  specIconContainer: (isHovered) => `p-2.5 rounded-xl mb-1.5 transition-all ${isHovered ? 'bg-gradient-to-r from-sky-500/10 to-teal-500/10' : 'bg-gray-100'}`,
  specIcon: (isHovered) => `w-4 h-4 ${isHovered ? 'text-orange-400' : 'text-gray-500'}`,
  specValue: "text-xs font-medium text-gray-600",
  ...
  borderOverlay: "absolute inset-0 rounded-2xl border border-gray-200/50 pointer-events-none",
  placeholder: "bg-white border-2 border-gray-200 border-dashed rounded-xl w-full h-full flex items-center justify-center text-sky-500",
  cardPatterns: [
    'bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-sky-100/80 via-white to-purple-100/60',
    'bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-emerald-100/80 via-white to-amber-100/60',
    'bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-violet-100/80 via-white to-rose-100/60',
    'bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-amber-100/80 via-white to-sky-100/60',
    'bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-rose-100/80 via-white to-emerald-100/60',
    'bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-purple-100/80 via-white to-amber-100/60'
  ],
  borderGradients: [
    'border-sky-500/30',
...
export const carDetailStyles = {
  pageContainer: "relative min-h-screen overflow-hidden py-6 px-4 sm:px-6 lg:px-8",
  contentContainer: "relative z-10 max-w-7xl mx-auto",
  backButton: "absolute top-1 cursor-pointer left-4 p-2 bg-gray-100 rounded-full shadow hover:shadow-lg z-20 border border-gray-200 hover:bg-gray-200 transition-all",
  backButtonIcon: "text-orange-400 text-lg",
  mainLayout: "pt-12 flex flex-col lg:flex-row gap-8",
  leftColumn: "lg:w-2/3 space-y-6",
  imageCarousel: "relative rounded-2xl overflow-hidden shadow-lg border border-gray-200",
  ...
  carPrice: "text-xl sm:text-2xl md:text-3xl font-bold text-green-600",
  pricePerDay: "text-base sm:text-lg font-normal text-gray-500",
  specsGrid: "grid grid-cols-2 sm:grid-cols-4 gap-4",
  specCard: "flex flex-col items-center surface-card p-3 sm:p-4 rounded-xl hover:border-orange-400 transition-all",
  specIcon: "text-xl sm:text-2xl mb-2 text-orange-600",
  specLabel: "text-xs sm:text-sm text-gray-500",
  specValue: "font-semibold text-base sm:text-lg text-gray-900",
  aboutSection: "surface-card p-4 sm:p-6 rounded-xl space-y-3",
  aboutTitle: "text-xl sm:text-2xl font-semibold text-gray-900",
  aboutText: "text-gray-600 text-sm sm:text-base",
  rightColumn: "lg:w-1/3",
  bookingCard: "surface-card p-4 sm:p-6 rounded-2xl space-y-4",
  bookingTitle: "text-2xl sm:text-2xl font-bold text-gray-900",
  bookingSubtitle: "text-gray-600 text-sm",
  form: "space-y-4",
  grid2: "grid grid-cols-2 gap-3",
  formLabel: "text-xs sm:text-sm text-gray-600 mb-1",
  inputContainer: (active) => `relative rounded-lg border transition-all ${active ? 'border-orange-500' : 'border-gray-300'}`,
  inputIcon: "absolute left-3 top-2.5 text-orange-400",
  inputField: "w-full pl-10 pr-2 py-1.5 sm:py-2 bg-transparent text-gray-700 text-sm sm:text-base outline-none",
  textInputField: "w-full pl-10 pr-3 py-1.5 sm:py-2 bg-transparent text-gray-700 text-sm sm:text-base outline-none",
  priceBreakdown: "bg-gray-100 p-3 rounded-lg text-sm space-y-1 border border-gray-300",
  priceRow: "flex justify-between text-gray-600",
  totalRow: "border-t border-gray-300 pt-1 flex justify-between font-semibold text-gray-900",
...
export const testimonialStyles = {
  container: "relative bg-white py-16 px-4 sm:px-6 lg:px-8 overflow-hidden",
  innerContainer: "max-w-7xl mx-auto relative z-10",
  headerContainer: "text-center mb-16",
  badge: "inline-flex items-center px-5 py-2 rounded-full bg-gray-50 border border-gray-200 backdrop-blur-sm mb-5",
  ...
  star: "mr-1",
  comment: "text-gray-600 italic text-lg mb-8",
  carInfo: "flex items-center mb-6 bg-gray-50 border border-gray-200 px-4 py-3 rounded-xl",
  ...
  authorInfo: "ml-4",
  authorName: "font-bold text-gray-900 text-lg",
  ...
  statsContainer: "mt-20 bg-gradient-to-r from-gray-50 to-white border border-gray-200 rounded-2xl overflow-hidden relative",
  ...
  ctaTitle: "text-3xl font-bold text-gray-900 font-[pacifico] mb-4",
  ...
  bottomGradient: "absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-gray-100 to-transparent z-0",
  cardShapes: [
...
export const footerStyles = {
  container: "relative bg-gradient-to-b from-gray-50 to-white text-gray-900 pt-16 sm:pt-20 md:pt-24 overflow-hidden",
  ...
  socialIcon: "w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 hover:bg-orange-400 transition-colors rounded-full flex items-center justify-center text-sm sm:text-base",
  ...
  input: "w-full bg-gray-100 border border-gray-200 rounded-lg py-2 px-3 sm:py-3 sm:px-4 focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900 text-sm sm:text-base",
  ...
  copyright: "border-t border-gray-200 mt-10 sm:mt-12 pb-4 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm sm:text-base",
...
export const contactPageStyles = {
  container: "relative min-h-screen py-8 px-4 sm:px-6 lg:px-8 overflow-hidden",
  ...
  content: "relative z-10 pt-20 max-w-6xl mx-auto",
  ...
  subtitle: "text-base sm:text-lg md:text-xl text-gray-600 max-w-xl mx-auto",
  cardContainer: "flex flex-col md:flex-row gap-6",
  infoCard: "md:w-2/5 surface-card rounded-2xl p-5 sm:p-6 relative overflow-hidden",
  ...
  infoTitle: "text-xl sm:text-xl font-semibold text-gray-900 flex items-center",
  infoIcon: "mr-3 text-orange-400 text-lg",
  infoItemContainer: "space-y-3",
  infoItem: "flex items-start bg-gray-100 p-3 rounded-lg hover:bg-gray-100 transition-all",
  iconContainer: (color) => `p-2 rounded-md mr-3 ${color}`,
  infoLabel: "font-medium text-gray-600 text-sm sm:text-base",
  ...
  offerTitle: "text-gray-600 font-medium text-sm sm:text-base",
  offerText: "text-gray-400 text-xs sm:text-sm mt-1",
  formCard: "md:w-3/5 surface-card rounded-2xl p-5 sm:p-6 relative overflow-hidden",
  ...
  formTitle: "text-lg sm:text-xl font-semibold text-gray-900 mb-1 flex items-center",
  ...
  input: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-50 border border-gray-200 text-gray-900 rounded-lg border ${
    isActive ? 'border-orange-500' : 'border-gray-300'
  } focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm transition-all`,
  select: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-50 border border-gray-200 cursor-pointer text-gray-900 rounded-lg border ${
    isActive ? 'border-orange-500' : 'border-gray-300'
  ...
  textarea: (isActive) => `w-full pl-10 pr-3 py-2 bg-gray-50 border border-gray-200 text-gray-900 rounded-lg border ${
    isActive ? 'border-orange-500' : 'border-gray-300'
  } focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm transition-all`,
...
export const carPageStyles = {
  pageContainer: "relative min-h-screen overflow-hidden pb-8 sm:pb-12 md:pb-16",
  contentContainer: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
  headerContainer:
    "relative w-full min-h-[240px] sm:min-h-[300px] md:min-h-[340px] bg-cover bg-no-repeat bg-top text-center mb-8 sm:mb-10 md:mb-12",
  headerContent:
    "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-8 sm:pb-10",
  headerOverlay:
    "absolute inset-0 bg-gradient-to-b from-black/30 via-black/10 to-transparent pointer-events-none",
  ...
  subtitle: "text-gray-500 max-w-2xl mx-auto text-sm sm:text-base",
  gridContainer: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 md:gap-10",
  carCard: "group relative surface-card rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1",
  ...
  carName: "text-lg sm:text-xl font-bold text-gray-900",
  carType: "text-sm text-orange-400",
  specsGrid: "grid grid-cols-2 gap-3 mb-5 text-sm text-gray-600",
  specItem: "flex items-center space-x-2",
  specIconContainer: "bg-gray-100 p-1.5 rounded-lg",
  bookButton: "metal-btn inline-flex items-center gap-3 px-5 py-3 rounded-lg font-medium transform-gpu hover:scale-[1.02] active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-orange-400 cursor-pointer w-full justify-center",
...
export const myBookingsStyles = {
  // Page container
  pageContainer: "min-h-screen pt-40 text-gray-900 py-12 px-4 sm:px-6 lg:px-8",
  ...
  filterButton: (isActive, type) => {
    ...
    if (!isActive) return `${base} bg-gray-100 text-gray-600 hover:bg-gray-200`;
  ...
  // Error state
  errorContainer: "text-center py-8 bg-gray-50 border border-gray-200 rounded-2xl",
  errorText: "text-red-400",
  retryButton: "mt-4 px-4 py-2 bg-orange-600 rounded-lg text-white",
  
  // Empty state
  emptyState: "text-center py-16 bg-gray-50 border border-gray-200 rounded-2xl",
  emptyIconContainer: "mx-auto w-24 h-24 rounded-full bg-gray-100 flex items-center justify-center mb-6",
  ...
  // Booking card
  bookingCard: "surface-card rounded-2xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-transform",
  ...
  detailSection: "space-y-4 mt-2 pt-4 border-t border-gray-200",
  detailItem: "flex items-center gap-3",
  detailIcon: "w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center text-orange-400",
  detailLabel: "text-gray-400 text-sm",
  detailValue: "font-medium",
  cardActions: "mt-6 pt-4 border-t border-gray-200 flex gap-3",
  viewDetailsButton: "flex-1 py-2 px-4 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center gap-2",
  bookAgainButton: "flex-1 py-2 px-4 bg-orange-600 hover:bg-orange-700 rounded-lg flex items-center justify-center gap-2",
  
  // Stats cards
  statsCard: "bg-gray-50 border border-gray-200 p-6 rounded-2xl",
  ...
  modalContainer: "surface-card rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto",
  modalHeader: "flex justify-between items-center mb-6",
  modalTitle: "text-2xl font-bold flex items-center gap-2",
  modalCloseButton: "p-2 rounded-full hover:bg-gray-200 transition-colors",
  ...
  carTag: "px-2 py-1 bg-gray-200 rounded text-sm",
  ...
  infoCard: "bg-gray-50 border border-gray-200 p-4 rounded-xl",
  infoRow: "flex justify-between mb-2",
  infoDivider: "mt-3 pt-3 border-t border-gray-200",
  modalActions: "flex gap-4",
  closeButton: "flex-1 py-3 px-4 bg-gray-200 hover:bg-gray-300 rounded-lg",
